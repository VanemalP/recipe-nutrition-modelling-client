...
export class SearchbarComponent implements OnInit {
    ...
    nutrientDisplayValues: string[] = ['Calories', 'Total Fat', 'Saturated Fat', 'Trans Fat', 'Cholesterol', 'Sodium', 'Total Carbohydrate', 'Dietary Fiber', 'Sugars', 'Protein', 'Vitamin A', 'Vitamin C', 'Vitamin E', 'Vitamin D', 'Calcium', 'Iron'];
    nutrientValues: string[] = ['ENERC_KCAL', 'FAT', 'FASAT', 'FATRN', 'CHOLE', 'NA', 'CHOCDF', 'FIBTG', 'SUGAR', 'PROCNT', 'VITA_IU', 'VITC', 'TOCPHA', 'VITD', 'CA', 'FE'];
